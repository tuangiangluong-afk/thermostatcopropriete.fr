                ...
                await resend.emails.send({
                    ...
                    html: `
                        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
                            <h1 style="color: #e11d48;">Nouveau Projet à Saisir</h1>
                            ...
                            <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px; border: 1px solid #e2e8f0; margin: 20px 0;">
                                ...
                                <ul style="list-style: none; padding: 0;">
                                    ...
                                    ${meta.monthly_bill ? `<li style="margin-bottom: 10px;">⚡ <strong>Facture Chauffage :</strong> ${meta.monthly_bill}</li>` : ''}
                                    ${meta.heating_type ? `<li style="margin-bottom: 10px;">🔥 <strong>Chauffage Actuel :</strong> ${meta.heating_type}</li>` : ''}
                                    ${meta.emitters_type ? `<li style="margin-bottom: 10px;">🌡️ <strong>Émetteurs :</strong> ${meta.emitters_type}</li>` : ''}
                                </ul>
                            </div>
...
export async function deliverUnlockedLead(leadId: string, partnerId: string) {
    ...
    if (resend && partner.email) {
        ...
        await resend.emails.send({
            ...
            html: `
                <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
                    <div style="background-color: #e11d48; color: white; padding: 30px; border-radius: 8px 8px 0 0; text-align: center;">
                    ...
                    <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 8px 8px; border: 1px solid #e2e8f0; border-top: none;">
                        ...
                        <ul style="list-style: none; padding: 0; font-size: 14px; color: #475569;">
                            ...
                            ${meta.monthly_bill ? `<li style="margin-bottom: 8px;"><strong>Facture Chauffage :</strong> ${meta.monthly_bill}</li>` : ''}
                            ${meta.heating_type ? `<li style="margin-bottom: 8px;"><strong>Chauffage Actuel :</strong> ${meta.heating_type}</li>` : ''}
                            ${meta.emitters_type ? `<li style="margin-bottom: 8px;"><strong>Émetteurs :</strong> ${meta.emitters_type}</li>` : ''}
                            ${lead.notes ? `<li style="margin-top: 15px; padding: 10px; background: #f8fafc; border-left: 4px solid #e11d48;"><strong>Note Admin :</strong> ${lead.notes}</li>` : ''}
                        </ul>
