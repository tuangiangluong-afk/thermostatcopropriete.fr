            ...
            <main className="container mx-auto max-w-3xl px-4 py-12 lg:py-20">
                ...
                <div className="prose prose-neutral prose-lg max-w-none">
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        ...
                        <p>
                            Le service proposé est la mise en relation avec des professionnels spécialisés dans l&apos;audit, le dimensionnement et l&apos;installation de solutions de pilotage du chauffage collectif, exerçant sur l&apos;ensemble du territoire national. L&apos;utilisation du service implique l&apos;acceptation sans réserve des présentes CGV.
                        </p>
                    </div>
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        ...
                        <ul className="list-disc pl-5 space-y-2">
                            <li><strong>Demande de mise en relation :</strong> L'utilisateur remplit un formulaire précisant son besoin (nombre de logements, type de chauffage collectif, régulation existante et objectifs du syndic).</li>
                            ...
                            <li><strong>Tarification des travaux :</strong> Le prix final de l'installation est déterminé par le professionnel partenaire après visite technique. Les estimations de rentabilité fournies sur le site sont indicatives.</li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        ...
                        <p>
                            <strong>WELINK TECH</strong> agit en qualité d&apos;intermédiaire technologique. La responsabilité de l'installation, de sa conformité technique et des assurances incombe exclusivement au professionnel partenaire ayant effectué les travaux.
                        </p>
                    </div>
                    ...
                    <div className="mb-8 rounded-2xl border-2 border-slate-200 bg-slate-50 p-8 shadow-sm">
                        ...
                        <p className="font-semibold text-slate-800">
                            Expert Thermostat Copropriété est une <strong>plateforme de mise en relation technique</strong> entre les utilisateurs et des professionnels indépendants du chauffage collectif et de la régulation.
                        </p>
                        <p className="mt-4 text-slate-700">
                            <strong>Expert Thermostat Copropriété n&apos;est pas une entreprise d&apos;installation ou de travaux.</strong> Les prestations sont effectuées par des professionnels indépendants ou des sociétés tierces, dûment assurés.
                        </p>
                        <p className="mt-4 text-slate-700">
                            En conséquence, <strong>WELINK TECH décline toute responsabilité</strong> en cas de litige lié à l&apos;exécution des travaux, incluant mais non limité à : malfaçons, retards de pose, non-obtention d'une aide ou d'une décision administrative ou tout dommage survenu pendant l'installation.
                        </p>
