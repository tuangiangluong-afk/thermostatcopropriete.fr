        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
            <div className="max-w-xl w-full bg-white rounded-3xl p-8 border shadow-xl text-center">
                ...
                <p className="text-slate-600 mb-8">
                    Votre demande de devis pour vos travaux de Thermostats Connectés a bien été enregistrée. Nos artisans partenaires certifiés étudient vos informations et vous recontacteront sous 24h à 48h.
                </p>
