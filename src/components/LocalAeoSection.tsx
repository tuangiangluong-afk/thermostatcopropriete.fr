...
const pricingMatrix = [{"name": "Pack Thermostat Connecté (par logement)", "usage": "Têtes électroniques intelligentes par radiateur", "price": "350€ - 650€ / lot", "aid": "Prime CEE Coup de Pouce 100%", "net": "0€ reste à charge"}, {"name": "Régulation Centrale & Sonde d'ambiance", "usage": "Pilotage chaufferie & équilibrage colonnes", "price": "1 200€ - 2 800€", "aid": "Financement CEE éligible", "net": "0€ reste à charge"}, {"name": "Gestion Technique Bâtiment (GTB) Copro", "usage": "Suivi conso en temps réel pour le syndic", "price": "Sur devis", "aid": "Primes CEE Bonifiées", "net": "Sur mesure"}, {"name": "Maintenance & Accompagnement résidents", "usage": "Remplacement piles & hotline dédiée", "price": "Inclus contrat CEE", "aid": "Garantie matériel 5 ans", "net": "Inclus"}];
