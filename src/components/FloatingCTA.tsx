    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 hidden lg:flex flex-col gap-3">
            ...
            <button
                ...
                className="bg-slate-600 hover:bg-slate-700 text-white font-bold py-3 px-6 rounded-full shadow-lg shadow-slate-600/30 flex items-center gap-2 transform hover:scale-105 transition-all"
            >
