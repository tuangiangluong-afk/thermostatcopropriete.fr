        ...
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    <span className="text-xs bg-amber-50 text-amber-600 px-3 py-1 rounded-full font-bold border border-amber-100 flex items-center gap-1">
                        <Globe size={12} /> Réseau Solaire Actif
                    </span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 hover:shadow-md transition border-l-4 border-l-amber-500">
                    <h3 className="text-xs font-bold text-slate-500 uppercase tracking-wide flex items-center gap-2">
                        <Users size={14} className="text-amber-500" /> Leads (Mois)
                    </h3>
                    <p className="text-3xl font-bold text-slate-900 mt-2">{recentLeads}</p>
                    <span className="text-xs text-amber-600 font-medium mt-1 inline-block">Mois en cours</span>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200">
                    ...
                    <div className="space-y-4">
                        <Link href="/admin/leads" className="flex items-center justify-between p-4 bg-slate-50 rounded-lg hover:bg-amber-50 hover:text-amber-700 transition group border border-slate-100">
                        ...
                        <Link href="/admin/sites" className="flex items-center justify-between p-4 bg-slate-50 rounded-lg hover:bg-amber-50 hover:text-amber-700 transition group border border-slate-100">
