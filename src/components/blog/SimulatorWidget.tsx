...
export default function SimulatorWidget() {
    return (
        <div className="bg-white p-6 rounded-2xl shadow-xl border border-slate-100 ring-1 ring-slate-500/10">
            ...
            <div className="space-y-3 mb-6">
                <div className="flex items-center p-3 border rounded-lg bg-slate-50 cursor-pointer hover:border-slate-500 hover:bg-slate-50 transition-colors">
