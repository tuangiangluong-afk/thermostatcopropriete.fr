...
interface CityCardProps {
    ...
    themeColor?: 'teal' | 'orange' | 'gold' | 'rose' | 'blue' | 'emerald' | 'amber' | 'purple';
}

export function CityCards({ cities, themeColor = 'gold' }: CityCardProps) {
    ...
    const theme = {
        ...
        orange: {
            hover: 'hover:border-slate-500 hover:shadow-xl',
            bg: 'bg-slate-100',
            text: 'text-slate-600'
        },
        gold: {
        ...
        emerald: {
            hover: 'hover:border-emerald-500 hover:shadow-xl',
            bg: 'bg-emerald-100',
